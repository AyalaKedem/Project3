...
export const menuArr: CategoryItem[] = [
  {
    id: v4(),
    category: "breakfast",
    name: "בוקר ליחיד",
    description:
      "ביצים לבחירה, סלט אישי קצוץ / עלים, לחם לבחירה: פוקאצ'ה / לחם דגנים / לחם לבן, בליוויסט מטבלים: פטה בשמן זית וזעתר, גבינת שמנת, סלט טונה במיונז, טחינה, ממרח חצילים שרופים, סלט אבוקדו, ריבת הבית, חמאה ומיני מוזלי, מוגש עם שתייה קלה וחמה.",
    price: 62,
    vegan: false,
    vegetarian: false,
    ordered: false,
  ...
  },
  {
    ...
    name: "בוקר טבעוני",
    description:
      "פנקייקים מעדשים כתומות, קרם קוקוס ועשבי תיבול, על מצע טחינה, בצל ופטריות מוקפצים, מוגש עם ממרח חצילים שרופים, זיתי הבית, לחם לבחירה, סלט אישי עלים / קצוץ, שתייה קלה וחמה. *שתייה חמה ניתן להזמין עם: משקה סויה / אורזושקדים / שאל את המלצר למשקאות נוספים.",
    price: 56,
    vegan: true,
    vegetarian: false,
    ordered: false,
  ...
  },
  {
    ...
    category: "starters",
    name: "פולנטה ופטריות",
    description: "קרם פולנטה בחמאה ושמנת, פטריות ושעועית ירוקה מוקפצים בתוספת קרם כמהין ופרמז'ן.",
    price: 48,
    vegan: false,
    vegetarian: true,
    ordered: false,
  },
  {
    ...
    category: "starters",
    name: "ארטישוק לימוני",
    description: "רבעי ארטישוק צרובים בחמאת לימון, מונחים על עלי רוקט טריים, פסטו, שקדים קלויים ופרמז'ן.",
    price: 48,
    vegan: false,
    vegetarian: true,
    ordered: false,
  ...
  },
  {
    ...
    category: "salads",
    name: "סלט ארטישוק",
    description: "עגבניות שרי בצבעים, עלי בזיליקום טרי, בצל סגול, ארטישוק, אגוזי מלך, עלים ירוקים וקרעי מוצרלה בתיבול שמן זית, לימון ובלסמי מצומצם.",
    price: 56,
    vegan: false,
    vegetarian: true,
    ordered: false,
  ...
  },
  {
    ...
    description: "נודלס, נתחי סלמון / טופו, בצל לבן וירוק, נענע, שעועית ירוקה ופטריות ברוטב אסייתי, כוסברה, אפונת וואסאבי ובוטנים מטוגנים.",
    price: 58,
    vegan: false,
    vegetarian: false,
    ordered: false,
